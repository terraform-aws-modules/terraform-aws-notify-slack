...
| <a name="input_log_level"></a> [log\_level](#input\_log\_level) | The log level of the Lambda function. Allowed values are DEBUG, INFO, WARNING, ERROR, CRITICAL | `string` | `"WARNING"` | no |
